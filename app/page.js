...
const worlds=[
 ...
 {id:'europe',name:'European History',desc:'Events, people, institutions and long processes across Europe.',status:'planned',target:'900–1,200'},{id:'modern-europe',name:'Modern European History',desc:'Europe from the post-WWI settlement to today: dictatorship, war, integration, communism, democracy and the security order.',status:'live',target:'228'},
